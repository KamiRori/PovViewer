export const IpcChannel = {
  ...
  selectExportDirectory: 'dialog:selectExportDirectory',
  beginExportVideoClips: 'export:beginVideoClips',
  exportVideoClip: 'export:videoClip',
  cancelExportVideoClip: 'export:cancelVideoClip',
